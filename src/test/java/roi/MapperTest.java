...
public class MapperTest {
	...
	@Test
	public void mapperTest() throws JsonParseException, JsonMappingException,
			IOException {
	...
	@Test
	public void calenderTest() throws JsonParseException, JsonMappingException,
			IOException {
		...
		DashboardTimeModel model = mapper.readValue(data,
				DashboardTimeModel.class);
