...
public class CalenderModel {
	...
	private static final String[] roomNos = { "201", "202", "203", "301",
			"302", "303", "401", "402", "df1", "df2", "df3", "df4", "df5",
			"dm1", "dm2", "dm3", "dm4", "dm5" };
	...
	public void putRooms(int id, String room, String rName) {
		if (this.rooms == null) {
